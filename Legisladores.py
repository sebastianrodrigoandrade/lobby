...
# BUSCADOR
# ---------------------------------------------------------
estado_label = "vigentes" if solo_vigentes else "históricos"
...
st.markdown(f"**{len(df_filtrado)} legisladores {estado_label}**")

st.dataframe(
    df_filtrado[['nombre_completo', 'bloque', 'distrito', 'camara', 'mandato_hasta', 'total_votos']].rename(columns={
        'nombre_completo': 'Nombre',
        'bloque': 'Bloque',
        'distrito': 'Distrito',
        'camara': 'Cámara',
        'mandato_hasta': 'Mandato hasta',
